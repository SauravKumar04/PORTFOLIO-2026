        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-xl sm:text-2xl font-serif italic border-l-4 border-black pl-6 mb-8">
              Currently studying at NIT Jamshedpur
            </p>
            <p className="text-base sm:text-lg leading-relaxed text-justify">
              <span className="text-4xl font-serif float-left mr-2 leading-none">S</span>trong grip on Data Structures & Algorithms and Full-Stack Web Development. Passionate about building scalable backend systems and clean user-centric interfaces.
            </p>
